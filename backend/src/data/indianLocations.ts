// Complete list of Indian States and Union Territories with their Districts
...
export const indianStates: StateData[] = [
  ...
  },
  {
    ...
    districts: [
      ...
      'Kotputli-Behror', 'Neem Ka Thana', 'Phalodi', 'Salumbar',
      'Sanchore', 'Shahpura'
    ]
  },
  {
